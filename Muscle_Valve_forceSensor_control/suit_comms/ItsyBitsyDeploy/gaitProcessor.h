...
class gaitProcessor {
    private:
        ...
        static const int T_array_size = 10;
    ...
    public:
        ...
        gaitProcessor(PressureSensor &footL, PressureSensor &footR, Serial_ *serialDebug, uint8_t pulsePin);
        void setSerialPort(Serial_ *serialDebug); //this doesn't work with non primitive datatypes! (right?)
        // void sendPulse();
