...
gaitProcessor::gaitProcessor(PressureSensor &footL, PressureSensor &footR, Serial_ *serialDebug, uint8_t pulsePin)
{
    this->_footL = footL;
    this->_footR = footR;
...
void gaitProcessor::setSerialPort(Serial_ * serialDebug)
{
  this->_serialDebug = serialDebug;
}