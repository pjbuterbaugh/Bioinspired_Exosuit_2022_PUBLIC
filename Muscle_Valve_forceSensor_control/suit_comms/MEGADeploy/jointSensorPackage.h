...
class jointSensorPackage 
{
    private:
        ...
        HardwareSerial *_serialDebug; //TESTING
    ...
    public: 
        jointSensorPackage(byte IMU0_ADDR, byte IMU1_ADDR, uint8_t LC0_P1, 
                                    ...
                                    HardwareSerial *serialDebug) : _IMU0_ADDR(IMU0_ADDR),
        ...
        jointSensorPackage(byte IMU0_ADDR, byte IMU1_ADDR, uint8_t LC0_P1, 
                                    ...
                                    HardwareSerial *serialDebug) : _IMU0_ADDR(IMU0_ADDR), _IMU1_ADDR(IMU1_ADDR), 
        ...
        jointSensorPackage() {}
        double * getData(sensorPacks aSensor);
        void printData();
        //imu::Quaternion getQuat(sensorPacks aSensor);
        packet constructPacket();
        bool init();
        void attach(HardwareSerial *serialTransmit, HardwareSerial *serialDebug);
        bool calibrate();
